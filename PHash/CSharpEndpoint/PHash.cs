...
namespace Hashing.Perceptual
{
    ...
    public class PHash
    {
        ...
        [DllImport("pHash", CharSet = CharSet.Ansi)]
        private static extern MVPRetCode ph_add_mvptree(ref MVPFile f, IntPtr[] points, 
            int num, ref int saved);
        ...
        [DllImport("pHash", CharSet = CharSet.Ansi)]
        public static extern IntPtr ph_mh_imagehash(string file, ref int n, float alpha, float lvl);
        ...
        [DllImport("pHash", CharSet = CharSet.Ansi)]
        private static extern IntPtr ph_readaudio(string file, int sr, int ch, float[] buf, 
            ref int buflen, float nbsecs);
        ...
        static PHash()
        {
            Environment.SetEnvironmentVariable("PATH",
                Environment.GetEnvironmentVariable("PATH") + ":/usr/local/lib");
        }
